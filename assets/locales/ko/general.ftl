...
video-background = 비디오 배경화면 사용
video-background-description = 공식 움직이는 배경화면을 다운로드 및 표시합니다.
...
disable-mhypbase-description = 실험적 기능입니다. 활성화하면 런처가 메인 패치 적용 중에 mhypbase.dll을 비활성화하며, 이는 현재 xlua 패치와 동일한 효과를 냅니다. 성능을 향상시키고 CPU 사용량을 줄입니다.
